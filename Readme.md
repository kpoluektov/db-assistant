...
**Что демонстрирует.** Веб-приложение, в котором с базой данных можно общаться на естественном языке. Пользователь задаёт вопрос на русском («сколько пассажиров летело из Москвы в июле?») — приложение само пишет SQL, выполняет его и возвращает ответ. Демо показывает, как на моделях Yandex AI Studio собрать ассистента для аналитиков, разработчиков и DBA, не выдавая им прямого доступа к БД и не требуя знания SQL.
